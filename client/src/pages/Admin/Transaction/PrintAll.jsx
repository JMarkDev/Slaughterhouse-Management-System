  ...
  return (
    <div ref={contentRef} className="font-sans leading-relaxed">
      {transactions.map((transaction, index) => (
        <div
          key={index}
          className="p-8 max-w-4xl mx-auto bg-white demand_letter"
          style={{ pageBreakAfter: "always" }} // Ensures each section starts on a new page
        >
          ...
          <section className="mb-8">
            ...
            <p className="mt-4">
              ...
              <span className="font-semibold">
                {transaction.owner.customerName}
              </span>
            </p>
            <p>Address: {transaction.owner.customerAddress}</p>
            <p>Contact: {transaction.owner.customerPhone}</p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">Dear {transaction.owner.customerName},</p>
            <p>
              ...
              remain unpaid and are now due for settlement. Below are the
              details of the unpaid amounts for your reference:
            </p>
